...
#| tal-cap: "Types of sanitatioin systems provided in eThekwini municipality"

sansubset5|>gt()|>tab_header(title="Informal Settlement in eThekwini",subtitle="Informal settlement")
```
