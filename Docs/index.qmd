...
sansubset5|>gt()|>
  cols_label(    SANITATION = "Sanitation Type",
    n = "Frequency"  )|>tab_header(title="Types of sanitation systems provided in eThekwini municipality.",subtitle="Informal settlement sanitaion provisions")
